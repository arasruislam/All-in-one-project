...
const ErrorState = ({ message, address, label }) => {
   return (
      <div className="min-h-[calc(100vh-127px)] gap-5 flex flex-col justify-center items-center pb-16 ">
         ...
         >
            ...
            <span className="absolute inset-0 w-full h-full bg-white border-2 border-[#23BE0A] group-hover:bg-[#23BE0A]"></span>
