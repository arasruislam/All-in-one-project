...
const Author = () => {
   ...
   return (
      <div className="flex flex-col mx-auto justify-center max-w-lg p-6 shadow-md rounded-xl sm:px-12">
         <img
            src={user?.profile_image || user?.profile_image_90}
            alt=""
         ...
         <div className="space-y-4 text-center divide-y divide-gray-700 dark:divide-gray-300">
            ...
            <div className="flex justify-center pt-2 space-x-4 align-center">
               <a
                  target="_blank"
                  href={`https://www.twitter.com/${user?.github_username}`}
                  aria-label="GitHub"
               ...
               <a
                  target="_blank"
                  href={`https://www.github.com/${user?.twitter_username}`}
                  aria-label="Twitter"
                  className="p-2 rounded-md text-gray-100 dark:text-gray-800 hover:text-violet-400 hover:dark:text-violet-600"
               >
                  <svg
